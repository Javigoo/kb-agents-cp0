...
\end{enumerate}
This information is used only for the  world environment object:
\begin{enumerate}
...
\begin{itemize}
\item {\tt runStepsSequence( int wDim, int barX, int barY,
                                    int numSteps, String fileSteps )}.
\item {\tt void main ( String[] args)}.
\end{itemize}
And this for the test class TreasureFinderTest:
\begin{itemize}
\item {\tt public void testMakeSimpleStep(  TreasureFinder bAgent,
                                   TFState targetState )}.
\item {\tt  testMakeSeqOfSteps( int wDim, int barX, int barY,
